...
def check_package_installed(from_code: str, to_code: str) -> bool:
    try:
        installed_packages: List[argostranslate.package.Package] = argostranslate.package.get_installed_packages()
...
def install_package(from_code: str, to_code: str) -> None:
    try:
        ...
        available_packages: List[argostranslate.package.Package] = argostranslate.package.get_available_packages()
