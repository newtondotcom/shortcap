...
def main():
    ...
    parser.add_argument(
        "--font-size", type=int, default=DEFAULT_FONT_SIZE, help="Font size"
    )
    parser.add_argument("--font-color", default=DEFAULT_FONT_COLOR, help="Font color")
    parser.add_argument(
        "--stroke-width", type=int, default=DEFAULT_STROKE_WIDTH, help="Stroke width"
    )
    parser.add_argument(
        "--stroke-color", default=DEFAULT_STROKE_COLOR, help="Stroke color"
    )
    parser.add_argument(
        "--highlight-current-word",
        action="store_true",
        default=DEFAULT_HIGHLIGHT_CURRENT_WORD,
        help="Highlight the current word",
    )
    parser.add_argument(
        "--word-highlight-color",
        default=DEFAULT_WORD_HIGHLIGHT_COLOR,
        help="Word highlight color",
    )
    parser.add_argument(
        "--line-count",
        type=int,
    ...
    parser.add_argument(
        "--padding", type=int, default=DEFAULT_PADDING, help="Padding around the text"
    )
    parser.add_argument(
        "--position", default=DEFAULT_POSITION, help="Vertical position of the text"
    )
    parser.add_argument(
        "--shadow-strength",
        type=float,
    ...
    parser.add_argument(
        "--shadow-blur", type=float, default=DEFAULT_SHADOW_BLUR, help="Shadow blur"
    )
    ...
    parser.add_argument(
        "--align-words",
        type=bool,
        help="Accurate word-level timestamps using wav2vec2 alignment",
    )
    parser.add_argument(
